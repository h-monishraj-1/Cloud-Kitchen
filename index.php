...
<head>
    ...
    <link rel="icon" href="#">
    <title>Home || Cloud Kitchen - Delicious Homemade Food</title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="nav-item"> <a class="nav-link active" href="restaurants.php">Chef <span class="sr-only"></span></a> </li>
            ...
            <div class="container text-center hero-text font-white">
                ...
                <div class="steps">
                    <div class="step-item step1">
                        ...
                        <h4><span style="color:white;">1. </span>Choose a Chef</h4>
                    </div>
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                <h2>Popular Delicacies of the Month</h2>
                <p class="lead">Easiest way to order your favourite food among these top 6 delicacies</p>
            </div>
            <div class="row">
                ...
                <div class="row how-it-works-solution">
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                        <div class="how-it-works-wrap">
                            <div class="step step-1">
                                ...
                                <h3>Choose Your Chef</h3>
                                <p>We've got you the best chefs around, offering delicious delicacies online.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                        <div class="step step-2">
                            ...
                            <h3>Choose Your Delicacy</h3>
                            <p>We've got your covered with delacies from a variety of professional chefs online.</p>
                        </div>
                    </div>
